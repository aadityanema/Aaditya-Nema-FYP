...
import com.gitdemo.client.MyRequestFactory.HelloWorldRequest;
import com.gitdemo.client.MyRequestFactory.MessageRequest;
import com.gitdemo.shared.MessageProxy;

public class GitdemoWidget extends Composite {
  ...
  interface GitdemoUiBinder extends UiBinder<Widget, GitdemoWidget> {
  }

  private static GitdemoUiBinder uiBinder = GWT.create(GitdemoUiBinder.class);
